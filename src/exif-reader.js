! function(e, t) {
    ...
    return function() {
        ...
        function c(e) {
            ...
            }), "")) : "undefined" != typeof Buffer ? void 0 !== n(Buffer.from) ? Buffer.from(e).toString("base64") : new Buffer(e).toString("base64") : void 0
        }
        ...
        var s = function() {
            function e(t) {
                if (function(e, t) {
                        ...
                        return "object" !== f(e) || void 0 === e.length || void 0 === e.readUInt8 || void 0 === e.readUInt16LE || void 0 === e.readUInt16BE || void 0 === e.readUInt32LE || void 0 === e.readUInt32BE || void 0 === e.readInt32LE || void 0 === e.readInt32BE
        ...
        function A(e, t) {
            return 65504 === e.getUint16(t) && "JFIF" === r(e, t + 4, 4) && 0 === e.getUint8(t + 4 + 4)
        }

        function I(e, t) {
            return e.getUint16(t) === h && "Exif" === r(e, t + 4, 4) && 0 === e.getUint8(t + 4 + 4)
        }

        function P(e, t) {
            return e.getUint16(t) === h && function(e, t) {
        ...
        function N(e, t) {
            var n = r(e, t + 4, 4);
            return "tEXt" === n || "iTXt" === n
        }

        function G(e, t) {
            return "eXIf" === r(e, t + 4, 4)
        }
        ...
        var V = function(e) {
                ...
                if (function(e) {
                    ...
                    for (var t, n, r, i, o, a, u, c, f, s = 2; s + 4 + 5 <= e.byteLength;) {
                        if (y(e, s)) n = s + 2;
                        else if (S(e, s)) r = s + 2;
                        else if (A(e, s)) t = e.getUint16(s + 2), i = s + 2;
                        else if (I(e, s)) t = e.getUint16(s + 2), o = s + 10;
                        else if (P(e, s)) u || (u = []), t = e.getUint16(s + 2), u.push(w(s, t));
                        else if (U(e, s)) u || (u = []), t = e.getUint16(s + 2), u.push(T(s, t));
                        else if (D(e, s)) t = e.getUint16(s + 2), a = s + 18;
                        else if (b(e, s)) {
                            var l = s + 18,
                ...
                if (function(e) {
                    ...
                    for (var t = {
                        ...
                        if (k(e, n)) t.hasAppMarkers = 1, t.pngHeaderOffset = n + 8;
                        else if (E(e, n)) {
                            var i = j(e, n);
                            void 0 !== i && (t.hasAppMarkers = 1, t.xmpChunks = [{
                                dataOffset: i,
                                length: e.getUint32(n + 0) - (i - (n + 8))
                            }])
                        } else if (N(e, n)) {
                            t.hasAppMarkers = 1;
                            var o = r(e, n + 4, 4);
                            t.pngTextChunks || (t.pngTextChunks = []), t.pngTextChunks.push({
                                length: e.getUint32(n + 0),
                                type: o,
                                offset: n + 8
                            })
                        } else G(e, n) ? (t.hasAppMarkers = 1, t.tiffHeaderOffset = n + 8) : B(e, n) && (t.hasAppMarkers = 1, t.pngChunkOffsets || (t.pngChunkOffsets = []), t.pngChunkOffsets.push(n + 0));
                    ...
                    var o = Math.min(n + i, e.byteLength),
                        a = function(e, t, n) {
                            for (var i = {
                                ...
                                var o = r(e, t, 4);
                                "iloc" === o ? i.ilocOffset = t : "Exif" === o ? i.exifItemOffset = t + -4 : "colr" === o && (i.colrOffset = t + -4), t++
                            }
                            return i
                        }(e, n, o),
                        u = a.exifItemOffset,
                ...
                if (function(e) {
                    ...
                    for (var t, n, i, o = 12, a = 0; o + 8 < e.byteLength;) {
                        var u = r(e, o, 4),
                            c = e.getUint32(o + 4, 1);
                        "EXIF" === u ? (a = 1, t = "Exif\0\0" === r(e, o + 8, 6) ? o + 8 + 6 : o + 8) : "XMP " === u ? (a = 1, n = [{
                            dataOffset: o + 8,
                            length: c
                        }]) : "ICCP" === u && (a = 1, i = [{
                            offset: o + 8,
            ...
            X = {
                ...
                getTypeSize: function(e) {
                    if (void 0 === H[e]) throw Error("No such type found.");
                    return W[H[e]]
                }
            };
        ...
        var K = {
            ...
            ExposureTime: function(e) {
                return e[0] >= e[1] ? "".concat(Math.round(e[0] / e[1])) : 0 !== e[0] ? "1/".concat(Math.round(e[1] / e[0])) : "0/".concat(e[1])
            },
            FNumber: function(e) {
        ...
        var Q = {
                            ...
                            var t, n = (2, function(e) {
                                    ...
                                    if (null != n) {
                                        var r, i, o = [],
                                            ...
                                            u = 0;
                                        try {
                                            for (n = n.call(e); !(a = (r = n.next()).done) && (o.push(r.value), 2 !== o.length); a = 1);
                                        } catch (e) {
                                            u = 1, i = e
                                        } finally {
                                            try {
                                    ...
                                    if (e) {
                                        ...
                                        return "Object" === n && e.constructor && (n = e.constructor.name), "Map" === n || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? $(e, 2) : void 0
                                    }
                                }(t) || function() {
            ...
            te = a({}, {
                ...
                282: {
                    name: "XResolution",
                    description: K.XResolution
                },
                283: {
                    name: "YResolution",
                    description: K.YResolution
                },
                ...
                33434: {
                    name: "ExposureTime",
                    description: K.ExposureTime
                },
                33437: {
                    name: "FNumber",
                    description: K.FNumber
                },
                34850: {
                    name: "ExposureProgram",
                    description: K.ExposureProgram
                },
                ...
                37121: {
                    ...
                    description: K.ComponentsConfiguration
                },
                37122: "CompressedBitsPerPixel",
                37377: {
                    name: "ShutterSpeedValue",
                    description: K.ShutterSpeedValue
                },
                37378: {
                    name: "ApertureValue",
                    description: K.ApertureValue
                },
                ...
                41488: {
                    ...
                    description: K.FocalPlaneResolutionUnit
                },
                41492: {
                    ...
                    description: function(e) {
                        var t, n = (2, function(e) {
                                ...
                                if (e) {
                                    ...
                                    var n = Object.prototype.toString.call(e).slice(8, -1);
                                    return "Object" === n && e.constructor && (n = e.constructor.name), "Map" === n || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? J(e, 2) : void 0
                                }
                            }(t) || function() {
                                throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                            }()),
                ...
                41985: {
                    name: "CustomRendered",
                    description: K.CustomRendered
                },
                41986: {
                    name: "ExposureMode",
                    description: K.ExposureMode
                },
                41987: {
                    name: "WhiteBalance",
                    description: K.WhiteBalance
                },
                41988: {
                ...
                41990: {
                    ...
                    description: K.SceneCaptureType
                },
                41991: {
                    name: "GainControl",
                    description: function(e) {
                ...
                41992: {
                    name: "Contrast",
                    description: K.Contrast
                },
                41993: {
                    name: "Saturation",
                    description: K.Saturation
                },
                41994: {
                    name: "Sharpness",
                    description: K.Sharpness
                },
                41995: {
            ...
            re = {
                ...
                9: X.getSlongAt,
                10: X.getSrationalAt,
                13: X.getIfdPointerAt
            },
            ie = function(e, t, n) {
                var r = v(e, t),
                    i = function(e, t, n, r) {
                        return de(e, "0th", t, ae(e, t, n), n, r)
                    }(e, t, r, n);
                return function(e, t, n, r, i) {
                    return void 0 !== e["Interoperability IFD Pointer"] ? a(e, de(t, "interoperability", n, n + e["Interoperability IFD Pointer"].value, r, i)) : e
                }(i = function(e, t, n, r, i) {
                    return void 0 !== e["GPS Info IFD Pointer"] ? a(e, de(t, "gps", n, n + e["GPS Info IFD Pointer"].value, r, i)) : e
                }(i = function(e, t, n, r, i) {
                    return void 0 !== e["Exif IFD Pointer"] ? a(e, de(t, "exif", n, n + e["Exif IFD Pointer"].value, r, i)) : e
                }(i, e, t, r, n), e, t, r, n), e, t, r, n)
            },
            oe = function(e, t, n) {
                var r = v(e, t);
                return function(e, t, n, r) {
                    ...
                    for (var o = [], a = 0; a < Math.ceil(n.MPEntry.value.length / i); a++) {
                        o[a] = {};
                        var f = ue(n.MPEntry.value, a * i, X.getTypeSize("LONG"), r);
                        o[a].ImageFlags = ce(f), o[a].ImageFormat = fe(f), o[a].ImageType = se(f);
                        var s = ue(n.MPEntry.value, a * i + 4, X.getTypeSize("LONG"), r);
                        o[a].ImageSize = {
                            value: s,
                            description: "" + s
                        };
                        var l = le(a) ? 0 : ue(n.MPEntry.value, a * i + 8, X.getTypeSize("LONG"), r) + t;
                        o[a].ImageOffset = {
                            value: l,
                            description: "" + l
                        };
                        var d = ue(n.MPEntry.value, a * i + 12, X.getTypeSize("SHORT"), r);
                        o[a].DependentImage1EntryNumber = {
                            value: d,
                            description: "" + d
                        };
                        var p = ue(n.MPEntry.value, a * i + 14, X.getTypeSize("SHORT"), r);
                        o[a].DependentImage2EntryNumber = {
                            value: p,
                            description: "" + p
                        }, o[a].image = e.buffer.slice(l, l + s), u(o[a], "base64", (function() {
                            return c(this.image)
                        }))
                    }
                    return n.Images = o, n
                }(e, t, de(e, "mpf", t, ae(e, t, r), r, n), r)
            };

        function ae(e, t, n) {
            return t + X.getLongAt(e, t + 4, n)
        }
        ...
        function de(e, t, n, r, i, o) {
            var a = X.getTypeSize("SHORT"),
                u = {},
                c = function(e, t, n) {
                    return t + X.getTypeSize("SHORT") <= e.byteLength ? X.getShortAt(e, t, n) : 0
                }(e, r, i);
            r += a;
            for (var f = 0; f < c && !(r + 12 > e.byteLength); f++) {
                var s = pe(e, t, n, r, i, o);
                void 0 !== s && (u[s.name] = {
                    id: s.id,
                    value: s.value,
            ...
            if (r < e.byteLength - X.getTypeSize("LONG")) {
                var l = X.getLongAt(e, r, i);
                0 !== l && (u.Thumbnail = de(e, t, n, n + l, i, 1))
            }
            return u
        }

        function pe(e, t, n, r, i, o) {
            var a, u = X.getTypeSize("SHORT"),
                c = u + X.getTypeSize("SHORT"),
                f = c + X.getTypeSize("LONG"),
                s = X.getShortAt(e, r, i),
                l = X.getShortAt(e, r + u, i),
                d = X.getLongAt(e, r + c, i);
            if (void 0 !== X.typeSizes[l] && (o || void 0 !== ne[t][s])) {
                if (function(e, t) {
                        return X.typeSizes[e] * t <= X.getTypeSize("LONG")
                    }(l, d)) a = me(e, r + f, l, d, i);
                else {
                    var p = X.getLongAt(e, r + f, i);
                    a = function(e, t, n, r, i) {
                        return t + n + X.typeSizes[r] * i <= e.byteLength
                    }(e, n, p, l, d) ? me(e, n + p, l, d, i, 33723 === s) : "<faulty value>"
                }
                l === X.tagTypes.ASCII && (a = function(e) {
                    try {
                        return e.map((function(e) {
                ...
                var m = "undefined-".concat(s),
                    g = a;
                if (void 0 !== ne[t][s])
                    if (void 0 !== ne[t][s].name && void 0 !== ne[t][s].description) {
                        m = ne[t][s].name;
                        try {
                            g = ne[t][s].description(a)
                        } catch (e) {
                            g = ge(a)
                        }
                    } else l === X.tagTypes.RATIONAL || l === X.tagTypes.SRATIONAL ? (m = ne[t][s], g = "" + a[0] / a[1]) : (m = ne[t][s], g = ge(a));
                return {
                    id: s,
                    name: m,
                    value: a,
        ...
        function me(e, t, n, r, i) {
            var o = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0,
                a = [];
            o && (r *= X.typeSizes[n], n = X.tagTypes.BYTE);
            for (var u = 0; u < r; u++) a.push(re[n](e, t, i)), t += X.typeSizes[n];
            return n === X.tagTypes.ASCII ? a = X.getAsciiValue(a) : 1 === a.length && (a = a[0]), a
        }
        ...
        var ve = function(e, t) {
            var n = function(e, t) {
                    return X.getShortAt(e, t)
                }(e, t),
                r = function(e, t, n) {
                    if (!(8 > n)) {
                        var r = X.getByteAt(e, t + 7);
                        return {
                            value: r,
                            description: "" + r
                        }
            ...
            return {
                "Bits Per Sample": he(e, t, n),
                "Image Height": ye(e, t, n),
                "Image Width": Se(e, t, n),
                "Color Components": r,
                Subsampling: r && be(e, t, r.value, n)
            }
        };

        function he(e, t, n) {
            if (!(3 > n)) {
                var r = X.getByteAt(e, t + 2);
                return {
                    value: r,
                    description: "" + r
                }
        ...
        function be(e, t, n, r) {
            if (!(8 + 3 * n > r)) {
                for (var i = [], o = 0; o < n; o++) {
                    var a = t + 8 + 3 * o;
                    i.push([X.getByteAt(e, a), X.getByteAt(e, a + 1), X.getByteAt(e, a + 2)])
                }
                return {
                    value: i,
                    description: i.length > 1 ? Ce(i) + Ae(i) : ""
                }
            }
        }
        ...
        var Ie = function(e, t) {
            var n = function(e, t) {
                ...
                o = {
                    "JFIF Version": Pe(e, t, n),
                    "Resolution Unit": Ue(e, t, n),
                    XResolution: Te(e, t, n),
                    YResolution: De(e, t, n),
        ...
        var Re = function(e, t) {
            ...
            Le = function(e, t, n) {
                try {
                    if (Array.isArray(e)) return Ge(new DataView(Uint8Array.from(e).buffer), {
                        size: e.length
                    }, 0, n);
                    var r = function(e, t) {
                    ...
                    return Ge(e, r.naaBlock, r.dataOffset, n)
                } catch (e) {
                    return {}
                }
            };
        ...
        function Be(e, t, n, r, i) {
            ...
            var u = function(e, t, n) {
                ...
                c = {
                    id: o,
                    name: je(xe.iptc[o], o, u),
                    value: u,
                    description: ze(xe.iptc[o], u, n, r)
                };
            return function(e) {
                    return xe.iptc[e] && xe.iptc[e].repeatable
                }(o) && (c.repeatable = 1),
                function(e) {
                    return xe.iptc[e] && void 0 !== xe.iptc[e].encoding_name
                }(o) && (c.encoding = xe.iptc[o].encoding_name(u)), {
                    tag: c,
                    tagSize: a
                }
        }
        ...
        var We = {
            ...
            "tiff:ResolutionUnit": function(e) {
                return K.ResolutionUnit(parseInt(e, 10))
            },
            "tiff:XResolution": function(e) {
                return He(K.XResolution, e)
            },
            "tiff:YResolution": function(e) {
                return He(K.YResolution, e)
            },
            "exif:ApertureValue": function(e) {
                return He(K.ApertureValue, e)
            },
            "exif:GPSLatitude": Ye,
            "exif:GPSLongitude": Ye,
            "exif:FNumber": function(e) {
                return He(K.FNumber, e)
            },
            "exif:FocalLength": function(e) {
                return He(K.FocalLength, e)
            },
            "exif:FocalPlaneResolutionUnit": function(e) {
                return K.FocalPlaneResolutionUnit(parseInt(e, 10))
            },
            "exif:ColorSpace": function(e) {
                return K.ColorSpace(function(e) {
            ...
            "exif:ComponentsConfiguration": function(e, t) {
                if (/^\d, \d, \d, \d$/.test(t)) {
                    ...
                    return K.ComponentsConfiguration(n)
                }
                return t
            },
            "exif:Contrast": function(e) {
                return K.Contrast(parseInt(e, 10))
            },
            "exif:CustomRendered": function(e) {
                return K.CustomRendered(parseInt(e, 10))
            },
            "exif:ExposureMode": function(e) {
                return K.ExposureMode(parseInt(e, 10))
            },
            "exif:ExposureProgram": function(e) {
                return K.ExposureProgram(parseInt(e, 10))
            },
            "exif:ExposureTime": function(e) {
                return Xe(e) ? K.ExposureTime(e.split("/").map((function(e) {
                    return parseInt(e, 10)
                }))) : e
            },
            "exif:MeteringMode": function(e) {
                return K.MeteringMode(parseInt(e, 10))
            },
            "exif:Saturation": function(e) {
                return K.Saturation(parseInt(e, 10))
            },
            "exif:SceneCaptureType": function(e) {
                return K.SceneCaptureType(parseInt(e, 10))
            },
            "exif:Sharpness": function(e) {
                return K.Sharpness(parseInt(e, 10))
            },
            "exif:ShutterSpeedValue": function(e) {
                return He(K.ShutterSpeedValue, e)
            },
            "exif:WhiteBalance": function(e) {
                return K.WhiteBalance(parseInt(e, 10))
            }
        };

        function He(e, t) {
            return Xe(t) ? e(t.split("/")) : t
        }
        ...
        function Ye(e) {
            var t, n = (2, function(e) {
                    ...
                    if (e) {
                        if ("string" == typeof e) return Ve(e, 2);
                        var n = Object.prototype.toString.call(e).slice(8, -1);
                        return "Object" === n && e.constructor && (n = e.constructor.name), "Map" === n || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Ve(e, 2) : void 0
                    }
                }(t) || function() {
                    throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                }()),
        ...
        var qe = function(e, t) {
            return "string" == typeof e ? Je({}, e) : function(e, t) {
                if (0 === t.length) return [];
                var n = [Ke(e, t.slice(0, 1))];
                return t.length > 1 && n.push(Ke(e, t.slice(1))), n
            }(e, t).reduce(Je, {})
        };
        ...
        function Je(e, t) {
            try {
                var n = function(e) {
                    ...
                    i = n.doc,
                    o = n.raw;
                return e._raw = (e._raw || "") + o, a(e, it(Qe($e(i), 1)))
            } catch (t) {
                return e
            }
        }
        ...
        function $e(e) {
            for (var t = 0; t < e.childNodes.length; t++) {
                if ("x:xmpmeta" === e.childNodes[t].tagName) return $e(e.childNodes[t]);
        ...
        function it(e) {
            ...
            for (var n in e) {
                ...
                Array.isArray(r) || (r = [r]), r.forEach((function(e) {
                    a(t, ot(e.attributes)), "object" === _e(e.value) && a(t, pt(e.value))
                }))
            }
            return t
        }
        ...
        function ot(e) {
            var t = {};
            for (var n in e) at(n) && (t[ct(n)] = {
                value: e[n],
                attributes: {},
                description: ft(e[n], n)
            });
            return t
        }

        function at(e) {
            return "rdf:parseType" !== e && !ut(e)
        }
        ...
        function ft(e) {
            ...
            if (Array.isArray(e)) {
                var n = st(e);
                return t && "function" == typeof We[t] ? We[t](e, n) : n
            }
            if ("object" === _e(e)) return lt(e);
            try {
                return t && "function" == typeof We[t] ? We[t](e) : decodeURIComponent(escape(e))
            } catch (t) {
                return e
            }
        }
        ...
        function st(e) {
            return e.map((function(e) {
                return void 0 !== e.value ? ft(e.value) : ft(e)
            })).join(", ")
        }

        function lt(e) {
            var t = [];
            for (var n in e) t.push("".concat(dt(n), ": ").concat(ft(e[n].value)));
            return t.join("; ")
        }
        ...
        function pt(e) {
            var t = {};
            for (var n in e) ut(n) || (t[ct(n)] = mt(e[n], n));
            return t
        }

        function mt(e, t) {
            return gt(e) ? vt(e, t) : yt(e) ? St(e, t) : bt(e) ? Ct(e, t) : function(e) {
                return void 0 !== At(e.value)
            }(e) ? function(e, t) {
                var n = At(e.value).value["rdf:li"],
                    r = ht(e),
                    i = [];
                return void 0 === n ? n = [] : Array.isArray(n) || (n = [n]), n.forEach((function(e) {
                    i.push(function(e) {
                        return gt(e) ? vt(e) : yt(e) ? St(e).value : bt(e) ? Ct(e).value : It(e)
                    }(e))
                })), {
                    value: i,
                    attributes: r,
        ...
        function vt(e, t) {
            var n = ht(e);
            void 0 !== e.value["rdf:Description"] && (e = e.value["rdf:Description"]), a(n, ht(e), function(e) {
                var t = {};
                for (var n in e.value) "rdf:value" === n || ut(n) || (t[ct(n)] = e.value[n].value);
                return t
            }(e));
            var r = function(e) {
                return Pt(e.value["rdf:value"]) || e.value["rdf:value"].value
            }(e);
            return {
                value: r,
                attributes: n,
        ...
        function ht(e) {
            var t = {};
            for (var n in e.attributes) "rdf:parseType" === n || "rdf:resource" === n || ut(n) || (t[ct(n)] = e.attributes[n]);
            return t
        }
        ...
        function St(e, t) {
            ...
            return void 0 !== e.value["rdf:Description"] && (a(n.value, ot(e.value["rdf:Description"].attributes)), a(n.attributes, ht(e)), e = e.value["rdf:Description"]), a(n.value, pt(e.value)), n.description = ft(n.value, t), n
        }
        ...
        var Dt = function(e, t) {
                try {
                    for (var n = t.reduce((function(e, t) {
                        ...
                        }, f = 1; f <= t.length; f++) c(f);
                    return function(e) {
                        var t = e.buffer,
                            n = e.getUint32();
                        if (e.byteLength !== n) throw Error("ICC profile length not matching");
                        if (e.length < 84) throw Error("ICC profile too short");
                        for (var o = {}, a = Object.keys(wt), u = 0; u < a.length; u++) {
                            var c = a[u],
                                f = wt[c],
                                s = f.value(e, parseInt(c, 10)),
                                l = s;
                            f.description && (l = f.description(s)), o[f.name] = {
                                value: s,
                                description: l
                            }
                        }
                        if (kt(t.slice(36, 40)) !== xt) throw Error("ICC profile: missing signature");
                        if (function(e) {
                                return e.length < 132
                            }(t)) return o;
                        for (var d = e.getUint32(128), p = 132, m = 0; m < d; m++) {
                            ...
                            if (y === Mt) {
                                ...
                                if (S > h) return o;
                                Et(o, g, kt(t.slice(v + 12, v + S + 11)))
                            } else if (y === Ot) {
                                for (var b = e.getUint32(v + 8), C = e.getUint32(v + 12), A = v + 16, I = [], P = 0; P < b; P++) {
                                    var U = r(e, A + 0, 2),
                                        w = r(e, A + 2, 2),
                                        T = e.getUint32(A + 4),
                                        D = e.getUint32(A + 8),
                                ...
                                if (1 === b) Et(o, g, I[0].text);
                                else {
                                    for (var M = {}, O = 0; O < I.length; O++) M["".concat(I[O].languageCode, "-").concat(I[O].countryCode)] = I[O].text;
                                    Et(o, g, M)
                                }
                            } else y === Ft ? Et(o, g, kt(t.slice(v + 8, v + h - 7))) : y === Rt && Et(o, g, kt(t.slice(v + 8, v + 12)));
                            p += 12
                        }
                        return o
        ...
        var Xt = function(e, t) {
                return t.reduce((function(t, n) {
                    var r = n.offset,
                        ...
                        a = n.type,
                        u = function(e, t, n, r) {
                            for (var i = [], a = [], u = [], c = [], f = Yt, s = 0; s < n && t + s < e.byteLength; s++) {
                                if (f === _t) {
                                    if (0 !== e.getUint8(t + s)) return {};
                                    s += 2, f = Jt(r, f)
                                }
                                var l = e.getUint8(t + s);
                                0 === l ? f = Jt(r, f) : f === Yt ? i.push(l) : f === qt ? a.push(l) : f === Kt ? u.push(l) : c.push(l)
                            }
                            var d = o(c);
                            return {
                                name: $t(r, a, i),
                                value: d,
                                description: r === F ? Re("UTF-8", c) : d
                            }
                        }(e, r, i, a),
                        c = u.name,
                        f = u.value,
            ...
            qt = "STATE_LANG",
            Kt = "STATE_TRANSLATED_KEYWORD";

        function Jt(e, t) {
            return t === Yt && e === F ? _t : t === _t ? qt : t === qt ? Kt : "STATE_TEXT"
        }

        function $t(e, t, n) {
            var r = o(n);
            if ("tEXt" === e || 0 === t.length) return r;
            var i = o(t);
            return "".concat(r, " (").concat(i, ")")
        }
        var Qt = function(e, t) {
            for (var n = {}, i = 0; i < t.length; i++) {
                var o = X.getLongAt(e, t[i] + 0),
                    a = r(e, t[i] + 4, 4);
                a === R ? (n["Pixels Per Unit X"] = Zt(e, t[i], o), n["Pixels Per Unit Y"] = en(e, t[i], o), n["Pixel Units"] = tn(e, t[i], o)) : a === L && (n["Modify Date"] = nn(e, t[i], o))
            }
            return n
        };
        ...
        function tn(e, t, n) {
            if (rn(e, t, n, 8, 1)) {
                var r = X.getByteAt(e, t + 8 + 8);
                return {
                    value: r,
                    description: 1 === r ? "meters" : "Unknown"
                }
            }
        }
        ...
        function nn(e, t, n) {
            if (rn(e, t, n, 0, 7)) {
                var r = X.getShortAt(e, t + 8),
                    i = X.getByteAt(e, t + 8 + 2),
                    o = X.getByteAt(e, t + 8 + 3),
                    a = X.getByteAt(e, t + 8 + 4),
                    u = X.getByteAt(e, t + 8 + 5),
                    c = X.getByteAt(e, t + 8 + 6);
                return {
                    value: [r, i, o, a, u, c],
                    description: "".concat(on(r, 4), "-").concat(on(i, 2), "-").concat(on(o, 2), " ").concat(on(a, 2), ":").concat(on(u, 2), ":").concat(on(c, 2))
                }
            }
        }
        ...
        var an = [6, 7, 99],
            un = function(e, t, n) {
                if ((i = t) && (void 0 === i.Compression || an.includes(i.Compression.value)) && i.JPEGInterchangeFormat && i.JPEGInterchangeFormat.value && i.JPEGInterchangeFormatLength && i.JPEGInterchangeFormatLength.value) {
                    t.type = "image/jpeg";
                    var r = n + t.JPEGInterchangeFormat.value;
                    t.image = e.buffer.slice(r, r + t.JPEGInterchangeFormatLength.value), u(t, "base64", (function() {
                        return c(this.image)
                    }))
                }
                var i;
        ...
        function dn(e, t) {
            return function(e) {
                ...
                return /^https?:\/\//.test(e) ? "undefined" != typeof fetch ? function(e) {
                    ...
                    if (-1 !== e.indexOf(";base64")) {
                        ...
                        return void 0 !== n(Buffer.from) ? Buffer.from(t, "base64") : new Buffer(t, "base64")
                    }
                    var r = decodeURIComponent(t);
                    return "undefined" != typeof Buffer ? void 0 !== n(Buffer.from) ? Buffer.from(r) : new Buffer(r) : Uint8Array.from(r, (function(e) {
                        return e.charCodeAt(0)
                    })).buffer
                }(e)) : function(e) {
                    var t = (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}).length;
            ...
            }(e) ? (r = e, new Promise((function(e, t) {
        ...
        function gn(e, t) {
            ...
            }(e) && (e = new Uint8Array(e).buffer), vn(function(e) {
                try {
        ...
        function vn(e) {
            ...
            if (Sn(p)) {
                c = 1;
                var I = ie(e, p, u);
                if (I.Thumbnail && (f.Thumbnail = I.Thumbnail, delete I.Thumbnail), r ? (f.exif = I, bn(f)) : f = a({}, f, I), I["IPTC-NAA"] && !Cn(m)) {
                    var P = Le(I["IPTC-NAA"].value, 0, u);
                    r ? f.iptc = P : f = a({}, f, P)
                }
                if (I.ApplicationNotes && !An(g)) {
                    var U = qe(o(I.ApplicationNotes.value));
                    r ? f.xmp = U : (delete U._raw, f = a({}, f, U))
                }
                if (I.ICC_Profile && !In(v)) {
                    var w = Dt(I.ICC_Profile.value, [{
                        offset: 0,
                        length: I.ICC_Profile.value.length,
                        chunkNumber: 1,
                        chunksTotal: 1
                    }]);
                    r ? f.icc = w : f = a({}, f, w)
            ...
            if (An(g)) {
                c = 1;
                var D = qe(e, g);
                r ? f.xmp = D : (delete D._raw, f = a({}, f, D))
            }
            if (In(v)) {
                c = 1;
                var x = Dt(e, v);
            ...
            if (Un(y)) {
                c = 1;
                var O = Nt(e, y);
                r ? (f.png = f.png ? a({}, f.png, O) : O, f.pngFile = O) : f = a({}, f, O)
            }
            if (wn(S)) {
                c = 1;
                var F = Xt(e, S);
                r ? (f.png = f.png ? a({}, f.png, F) : F, f.pngText = F) : f = a({}, f, F)
            }
            if (Tn(b)) {
                c = 1;
                var R = Qt(e, b);
                r ? f.png = f.png ? a({}, f.png, R) : R : f = a({}, f, R)
            }
            var L = un(e, f.Thumbnail, p);
            if (L ? (c = 1, f.Thumbnail = L) : delete f.Thumbnail, !c) throw new fn.MetadataMissingError;
            return f
        }
        ...
        function bn(e) {
            if (e.exif) {
                if (e.exif.GPSLatitude && e.exif.GPSLatitudeRef) try {
                    e.gps = e.gps || {}, e.gps.Latitude = p(e.exif.GPSLatitude.value), "S" === e.exif.GPSLatitudeRef.value.join("") && (e.gps.Latitude = -e.gps.Latitude)
                } catch (e) {}
                if (e.exif.GPSLongitude && e.exif.GPSLongitudeRef) try {
                    e.gps = e.gps || {}, e.gps.Longitude = p(e.exif.GPSLongitude.value), "W" === e.exif.GPSLongitudeRef.value.join("") && (e.gps.Longitude = -e.gps.Longitude)
                } catch (e) {}
