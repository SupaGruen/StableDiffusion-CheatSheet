document.addEventListener("DOMContentLoaded",function(event){
    ...
    var DontShowAnyCountries = ['Sweden','USA','Ukraine','Belarus','Spain','Brazil','Denmark','Japan','Austria','France','Philippines','UK','Poland','Poland','Germany','Canada','Netherlands','Italy','Taiwan','Belgium','Russia','Australia','Czech Republic','Bulgaria','China'];
